(function () {
	...
	/* src/common/Context.svelte generated by Svelte v3.0.0 */
	...
	/* src/sections/Form.svelte generated by Svelte v3.0.0 */
	...
	function create_each_block_1(ctx) {
		...
		return {
			c: function create() {
				...
				add_location(option, file$2, 64, 3, 3147);
			},
	...
	function create_each_block$1(ctx) {
		...
		return {
			c: function create() {
				...
				option.__value = option_value_value = ctx.option.value;
				option.value = option.__value;
				add_location(option, file$2, 73, 3, 3461);
			},
	...
	function create_fragment$2(ctx) {
		var app_context, t0, zoo_grid, tr0, th0, t2, th1, t4, tr1, td0, td1, t7, tr2, td2, td3, t10, tr3, td4, td5, t13, tr4, td6, td7, t16, tr5, td8, div0, t18, td9, div1, zoo_select0, select0, option0, option1, option2, t22, form, zoo_input0, input0, t23, zoo_input1, input1, t24, zoo_input2, input2, t25, zoo_input3, input3, t26, zoo_input4, textarea, t27, zoo_select1, select1, option3, option4, option5, option6, t32, zoo_select2, select2, option7, option8, option9, option10, t37, zoo_searchable_select0, select3, t38, zoo_searchable_select1, select4, t39, zoo_checkbox, input4, t40, zoo_radio0, template, input5, t41, label0, t43, input6, t44, label1, t46, input7, t47, label2, t49, zoo_radio1, input8, t50, label3, t52, input9, t53, label4, t55, div2, zoo_button, span, dispose;
		...
		return {
			c: function create() {
				...
				add_location(th0, file$2, 4, 2, 208);
				add_location(th1, file$2, 5, 2, 239);
				attr(tr0, "slot", "header");
				add_location(tr0, file$2, 3, 1, 187);
				add_location(td0, file$2, 7, 16, 294);
				add_location(td1, file$2, 7, 39, 317);
				attr(tr1, "slot", "row");
				add_location(tr1, file$2, 7, 1, 279);
				add_location(td2, file$2, 8, 16, 362);
				add_location(td3, file$2, 8, 39, 385);
				attr(tr2, "slot", "row");
				add_location(tr2, file$2, 8, 1, 347);
				add_location(td4, file$2, 9, 16, 430);
				add_location(td5, file$2, 9, 39, 453);
				attr(tr3, "slot", "row");
				add_location(tr3, file$2, 9, 1, 415);
				add_location(td6, file$2, 10, 25, 507);
				add_location(td7, file$2, 10, 48, 530);
				attr(tr4, "slot", "row");
				attr(tr4, "disabled", "");
				add_location(tr4, file$2, 10, 1, 483);
				add_location(div0, file$2, 12, 6, 585);
				add_location(td8, file$2, 12, 2, 581);
				option0.__value = "5";
				option0.value = option0.__value;
				add_location(option0, file$2, 17, 6, 813);
				option1.__value = "10";
				option1.value = option1.__value;
				add_location(option1, file$2, 18, 6, 838);
				option2.__value = "15";
				option2.value = option2.__value;
				add_location(option2, file$2, 19, 6, 864);
				attr(select0, "type", "number");
				attr(select0, "slot", "selectelement");
				set_style(select0, "padding", "3px");
				add_location(select0, file$2, 16, 5, 741);
				set_custom_element_data(zoo_select0, "labelposition", "left");
				set_custom_element_data(zoo_select0, "labeltext", "Page size:");
				add_location(zoo_select0, file$2, 15, 4, 679);
				set_style(div1, "width", "100px");
				set_style(div1, "margin-left", "auto");
				add_location(div1, file$2, 14, 3, 628);
				add_location(td9, file$2, 13, 2, 620);
				attr(tr5, "slot", "footer");
				add_location(tr5, file$2, 11, 1, 560);
				add_location(zoo_grid, file$2, 2, 0, 175);
				attr(input0, "slot", "inputelement");
				attr(input0, "type", "text");
				input0.placeholder = "input";
				add_location(input0, file$2, 29, 2, 1211);
				...
				add_location(zoo_input0, file$2, 27, 1, 975);
				attr(input1, "slot", "inputelement");
				attr(input1, "type", "number");
				input1.placeholder = "input";
				add_location(input1, file$2, 33, 2, 1481);
				...
				add_location(zoo_input3, file$2, 39, 1, 1888);
				attr(textarea, "slot", "inputelement");
				textarea.placeholder = "Textarea";
				add_location(textarea, file$2, 43, 2, 2108);
				set_custom_element_data(zoo_input4, "labeltext", "Textarea example");
				set_custom_element_data(zoo_input4, "valid", ctx.inputState);
				add_location(zoo_input4, file$2, 42, 1, 2044);
				option3.className = "placeholder";
				option3.__value = "";
				option3.value = option3.__value;
				option3.disabled = true;
				option3.selected = true;
				add_location(option3, file$2, 47, 3, 2380);
				option4.__value = "1";
				option4.value = option4.__value;
				add_location(option4, file$2, 48, 3, 2459);
				option5.__value = "2";
				option5.value = option5.__value;
				add_location(option5, file$2, 49, 3, 2481);
				option6.__value = "3";
				option6.value = option6.__value;
				add_location(option6, file$2, 50, 3, 2503);
				attr(select1, "slot", "selectelement");
				select1.multiple = true;
				add_location(select1, file$2, 46, 2, 2338);
				...
				add_location(zoo_select1, file$2, 45, 1, 2188);
				option7.className = "placeholder";
				option7.__value = "";
				option7.value = option7.__value;
				option7.disabled = true;
				option7.selected = true;
				add_location(option7, file$2, 55, 3, 2737);
				option8.__value = "1";
				option8.value = option8.__value;
				add_location(option8, file$2, 56, 3, 2816);
				option9.__value = "2";
				option9.value = option9.__value;
				add_location(option9, file$2, 57, 3, 2838);
				option10.__value = "3";
				option10.value = option10.__value;
				add_location(option10, file$2, 58, 3, 2860);
				attr(select2, "slot", "selectelement");
				add_location(select2, file$2, 54, 2, 2704);
				...
				add_location(zoo_select2, file$2, 53, 1, 2550);
				select3.multiple = true;
				attr(select3, "slot", "selectelement");
				add_location(select3, file$2, 62, 2, 3076);
				...
				add_location(zoo_searchable_select0, file$2, 61, 1, 2907);
				attr(select4, "slot", "selectelement");
				add_location(select4, file$2, 71, 2, 3399);
				...
				add_location(zoo_searchable_select1, file$2, 70, 1, 3260);
				attr(input4, "slot", "checkboxelement");
				attr(input4, "type", "checkbox");
				add_location(input4, file$2, 80, 2, 3718);
				...
				add_location(zoo_checkbox, file$2, 79, 1, 3574);
				attr(input5, "type", "radio");
				input5.id = "contactChoice1";
				input5.name = "contact";
				input5.value = "email";
				input5.disabled = true;
				add_location(input5, file$2, 84, 3, 3874);
				label0.htmlFor = "contactChoice1";
				add_location(label0, file$2, 85, 3, 3956);
				attr(input6, "type", "radio");
				input6.id = "contactChoice2";
				input6.name = "contact";
				input6.value = "phone";
				add_location(input6, file$2, 86, 3, 4001);
				label1.htmlFor = "contactChoice2";
				add_location(label1, file$2, 87, 3, 4074);
				attr(input7, "type", "radio");
				input7.id = "contactChoice3";
				input7.name = "contact";
				input7.value = "mail";
				add_location(input7, file$2, 88, 3, 4119);
				label2.htmlFor = "contactChoice3";
				add_location(label2, file$2, 89, 3, 4191);
				add_location(template, file$2, 83, 2, 3860);
				...
				add_location(zoo_radio0, file$2, 82, 1, 3785);
				attr(input8, "type", "radio");
				input8.id = "contactChoice4";
				input8.name = "contact";
				input8.value = "email";
				input8.disabled = true;
				add_location(input8, file$2, 94, 2, 4337);
				label3.htmlFor = "contactChoice4";
				add_location(label3, file$2, 95, 2, 4418);
				attr(input9, "type", "radio");
				input9.id = "contactChoice5";
				input9.name = "contact";
				input9.value = "phone";
				add_location(input9, file$2, 96, 2, 4462);
				label4.htmlFor = "contactChoice5";
				add_location(label4, file$2, 97, 2, 4534);
				...
				add_location(zoo_radio1, file$2, 93, 1, 4262);
				form.className = "form";
				add_location(form, file$2, 26, 0, 954);
				attr(span, "slot", "buttoncontent");
				span.className = "slotted-span";
				add_location(span, file$2, 102, 2, 4685);
				set_custom_element_data(zoo_button, "type", "hot");
				set_custom_element_data(zoo_button, "size", "medium");
				add_location(zoo_button, file$2, 101, 1, 4620);
				div2.className = "submit";
				add_location(div2, file$2, 100, 0, 4598);
	...
	class Form extends SvelteElement {
		...
		/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */</style>`;
	...
	/* src/sections/Buttons.svelte generated by Svelte v3.0.0 */
	...
	/* src/sections/TooltipAndFeedback.svelte generated by Svelte v3.0.0 */
	...
	/* src/docs/ButtonDocs.svelte generated by Svelte v3.0.0 */
	...
	/* src/docs/CheckboxDocs.svelte generated by Svelte v3.0.0 */
	...
	/* src/docs/CollapsableListDocs.svelte generated by Svelte v3.0.0 */
	...
	/* src/docs/FeedbackDocs.svelte generated by Svelte v3.0.0 */
	...
	/* src/docs/FooterDocs.svelte generated by Svelte v3.0.0 */
	...
	/* src/docs/HeaderDocs.svelte generated by Svelte v3.0.0 */
	...
	/* src/docs/InputDocs.svelte generated by Svelte v3.0.0 */
	...
	/* src/docs/LinkDocs.svelte generated by Svelte v3.0.0 */
	...
	/* src/docs/ModalDocs.svelte generated by Svelte v3.0.0 */
	...
	/* src/docs/NavigationDocs.svelte generated by Svelte v3.0.0 */
	...
	/* src/docs/RadioDocs.svelte generated by Svelte v3.0.0 */
	...
	/* src/docs/SearchableSelectDocs.svelte generated by Svelte v3.0.0 */
	...
	/* src/docs/SelectDocs.svelte generated by Svelte v3.0.0 */
	...
	/* src/docs/ToastDocs.svelte generated by Svelte v3.0.0 */
	...
	/* src/docs/TooltipDocs.svelte generated by Svelte v3.0.0 */
	...
	/* src/docs/ThemingDocs.svelte generated by Svelte v3.0.0 */
